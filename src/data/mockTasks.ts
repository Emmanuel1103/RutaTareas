...
export const mockTasks: Task[] = [
  {
    id: "1",
    name: "Implementación Sistema de Gestión Documental",
    theme: "Tecnología",
  ...
  {
    id: "3",
    name: "Talleres de Educación Financiera",
    theme: "Educación",
  ...
  {
    id: "4",
    name: "Actualización de Infraestructura Eléctrica",
  ...
  {
    id: "5",
    name: "Programa de Becas Universitarias",
    theme: "Educación",
